...
const MetricsCard = ({
    ...
    <div className="flex flex-col rounded-xl bg-white shadow-sm dark:border-neutral-800 dark:bg-[#13131a] ">
        <div className="flex justify-between gap-x-3 p-4 md:p-5">
            <div className="">
                <p className="text-xs uppercase tracking-wide text-neutral-500" >{title}</p>
            <div className="mt-1 flex items-center gap-x-2 ">
                <h3
                className="text-xl font-medium text-neutral-200 sm:text-xl">
                    {value}
                </h3>
            </div>
            </div>
